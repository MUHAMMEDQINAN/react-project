...
import { GridLensLogo } from "@/components/icons"
...
export function DashboardHeader() {
  ...
  const { role, participant, logout } = useAuth();
  ...
  return (
    <header className="flex h-16 shrink-0 items-center justify-between border-b bg-card px-4 md:px-6">
      <div className="flex items-center gap-3">
        <GridLensLogo className="h-7 w-7 text-primary" />
        <h1 className="text-xl font-bold text-foreground">GridLens</h1>
      </div>
